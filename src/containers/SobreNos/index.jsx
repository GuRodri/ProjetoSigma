...
const SobreNos = () => {
  return (
    <Container>
      <Title><Image src={gamerImage} alt="Gamer" style={{ width: '5em', height: '5em' }} />Sobre a Sigma Hardware</Title>
      <Paragraph1>
        Seja bem-vindo à Sigma Hardware, onde a paixão pelo gaming se encontra com a excelência em tecnologia.
      </Paragraph1>
      <ContainerEstilo>
        <Paragraph>
          <IconWrapper><FaShoppingCart style={{ width: '5em', height: '5em', color:'yellow' }} /></IconWrapper>
        ...
        <Paragraph>
          <IconWrapper><FaHandshake style={{ width: '5em', height: '5em', color:'#25D62C' }} /></IconWrapper>
        ...
        <Paragraph>
          <IconWrapper><FaUsers style={{ width: '5em', height: '5em', color:'#4556F2' }} /></IconWrapper>
        ...
        <Paragraph>
          <IconWrapper><FaEye style={{ width: '5em', height: '5em', color:'#d9d9d9' }} /></IconWrapper>
