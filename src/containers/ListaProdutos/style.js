...
export const TableImage = styled.img`
    ...
    object-fit: cover;
    display: block;
    background: linear-gradient(135deg, #e0e3ea 60%, #c2e9fb 100%);
    box-shadow: 0 2px 8px rgba(44,46,74,0.18), 0 0 0 3px #c2e9fb44;
    border: 2px solid #c2e9fb;
    transition: box-shadow 0.2s, border 0.2s;

    &:hover {
        box-shadow: 0 4px 16px rgba(44,46,74,0.28), 0 0 0 4px #7fd8f7aa;
        border: 2.5px solid #7fd8f7;
    }
`;
